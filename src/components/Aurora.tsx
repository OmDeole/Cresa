...
export default function Aurora(props: AuroraProps) {
  const { colorStops = ['#FF6E00', '#FF6E00', '#FF6E00'], amplitude = 1.0, blend = 0.5 } = props;
  ...
  useEffect(() => {
    ...
    ctn.appendChild((gl as any).canvas);
    ...
    return () => {
      ...
      if (ctn && (gl as any).canvas.parentNode === ctn) {
        ctn.removeChild((gl as any).canvas);
      }
